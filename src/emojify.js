...
module.exports = function emojify(el) {
    ...
    function rotateAnimation(reverse = false) {
    ...
    function blinkAnimation() {
        ...
        const timeBetweenFrames = 1000 / 5; // 5 updates per second
        let lastRender
        ...
        function animateLoop(timestamp) {
            ...
            if (renderElapsed > timeBetweenFrames) {
                for (let i = 0; i < allEms.length; i++) {
                    allEms[i].style.display = shown ? 'none' : 'block'
                }
                shown = !shown
    ...
    e.rotateAnimation = function() {
        stopAnimation()
        rotateAnimation()
    }

    e.rotateAnimationReversed = function() {
        stopAnimation()
        rotateAnimation(true)
    }

    e.randomSwapAnimation = function() {
        stopAnimation()
        randomSwapAnimation()
    }

    e.blinkAnimation = function() {
        stopAnimation()
        blinkAnimation()
    }
