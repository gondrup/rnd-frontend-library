    ...
    function animate() {
        ...
        function animateLoop(timestamp) {
            ...
            if (renderElapsed > timeBetweenFrames) {
                ...
                //let prevContent = allEms[allEms.length - 1]
                for (let i = 0; i < allEms.length - 2; i++) {
                    //const curContent = allEms[i].innerText
                    //allEms[i + 1].innerText = prevContent
                    //prevContent = curContent
                    allEms[i].innerText = allEms[i + 1].innerText
                }
